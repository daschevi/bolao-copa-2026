...
export function MatchCard({ match, showBet = true }: Props) {
  ...
  // Admin segue as mesmas regras de prazo que usuários comuns.
  // A única diferença é que admin também pode definir resultados oficiais.
  const canBet      = !isPlayed && betOpen && teamsReady && phaseVisible;
  ...
  return (
    <>
      ...
      >
        ...
        {/* Rodapé: palpite / status — mesmas regras para admin e usuário comum */}
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {/* Tabs: admin alterna entre palpite e resultado oficial */}
            {isAdmin && (
              <div
            ...
            {/* ── Aba: Palpite (usuário comum sempre; admin quando na aba "bet") ── */}
            ...
            {/* ── Aba: Resultado oficial (somente admin, quando na aba "result") ── */}
            {tab === 'result' && isAdmin && (
              <div>
